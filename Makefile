...
#
.DEFAULT_GOAL		:= build
SQLITE_AMALGATION	:= sqlite-amalgamation-3490100
SQLITE_SOURCEURL	:= https://sqlite.org/2025/$(SQLITE_AMALGATION).zip  # SQLite --version 3.49.1 Source Code: https://www.sqlite.org/download.html
